...
// Safety: records array may be missing
...
rep += `👥 Current Members: ${latest.total ?? 0}\n`;
rep += `✅ Present: ${latest.present ?? 0} (${latest.percentPresent ?? "0.0"}%)\n`;
rep += `❌ Absent: ${latest.absent ?? 0} (${latest.percentAbsent ?? "0.0"}%)\n`;
